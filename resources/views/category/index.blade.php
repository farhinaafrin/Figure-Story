                    ...
                    <div class="card-body p-0">
                        <table class="table table-striped">
                            ...
                            <tbody>
                                    ...
                                    <td>{{ $category->id }}</td>
                                    <td class="d-flex">
                                        <a href="{{ route('category.edit',[$category->id]) }}" class="btn btn-sm btn-secondary mr-1"><i class="fas fa-edit"></i></a>
                                        ...
                                        {{-- <a href="{{ route('category.show',[$category->id]) }}" class="btn btn-sm btn-info mr-1"><i class="fas fa-eye"></i></a> --}}
                                        </td>
                                </tr>
                                    @endforeach
